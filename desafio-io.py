...
def log_transacao(func, *args, **kwargs):
    ...
    def envelope(*args, **kwargs):
        ...
        caminho_arquivo = ROOT_PATH / "log.txt"
        with open(caminho_arquivo, "a") as arquivo:
            entrada_log = f"[{ts}]\t{func.__name__.upper()} executada com os argumentos {args} e {kwargs}. Retornou {resultado}\n"
            arquivo.write(entrada_log)
        return resultado
    return envelope
